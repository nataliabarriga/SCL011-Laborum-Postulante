...
const jobs = Jobs()
  return (
    <div>
      <div id="headerCv" className="col-8">
      <button className="buttonback">Volver</button>
      <p className="view">Así se muestra tu perfil a las empresas </p>
      <button className="download">Descargar</button>
      </div>
{jobs.map((Jobs) =>
<div className="containerCv">
      <div className="headboard"> 
      <p className="nameUser">{Jobs.nameUser}  {Jobs.lastName}</p> 
      </div>
...
<p className="dateOfBirth">{Jobs.dateOfBirth}</p>
      ...
      <p className="workSince">{Jobs.workSince} - {Jobs.workUntil}</p>
      
      </div>  
      <section className="sectionDescription">
      <h3 className="workDescription">{Jobs.workDescription}</h3> 
      ...
      <div className="containerDataUser">
      <div className="sectionDate">   
      <p className="educationTitle">{Jobs.educationTitle}</p>
      <p className="educationSince">{Jobs.educationSince}-{Jobs.educationUntil}</p>
      </div>
      <section className="sectionDescription">
      <p className="educationDescription">{Jobs.educationDescription}</p>
