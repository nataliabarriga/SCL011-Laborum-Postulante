...
import Job from '../img/JobsOfferts.png';
import Seemore from '../img/Seemore.png';

function WorksOffers() {
  const [jobs, setWorks] = useState([]);
  useEffect(() => {
    db
      .collection('jobapproved')
      .onSnapshot((snapshot) => {
      ...
      <section className="job-box col-11">
        {jobs.map((Jobs) =>
          <div className="job-offer">
            ...
            <button className="job-status">No revisado</button>
            ...
            <div className="iconPlace2">
              <svg id="star" className="star-icon2" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
